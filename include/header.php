...
<head>
    ...
    <title>Zapped</title>
    <link rel="stylesheet" href="http://localhost/comercio/proyecto/include/header.css">
        ...
        <div class="contenedor container">
            <div class="header-content">
                <div class="logo-nav">
                    ...
                    <nav class="nav">
                        <a href="http://localhost/comercio/proyecto/navegacion/news.php">News</a>
                        <span>|</span>
                        <a href="http://localhost/comercio/proyecto/navegacion/men.php">Men</a>
                        <span>|</span>
                        <a href="http://localhost/comercio/proyecto/navegacion/women.php">Women</a>
                        <span>|</span>
                        <a href="http://localhost/comercio/proyecto/navegacion/kids.php">Kids</a>
                    </nav>
                </div>
