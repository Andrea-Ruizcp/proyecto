...
$consulta = "SELECT * FROM `productos` WHERE categoria = 'men'";
...
<body>
    ...
    <div class="image container mt-3">
        <img src="http://localhost/comercio/proyecto/image/men1.png" alt="imagen" class="imagen">
    </div>  
    ...
    <div class="deporte container mt-5">
        ...
        <div class="slider">
            <img src="http://localhost/comercio/proyecto/image/sport1.png" alt="Deporte 1">
            <img src="http://localhost/comercio/proyecto/image/sport2.png" alt="Deporte 2">
            <img src="http://localhost/comercio/proyecto/image/sport3.png" alt="Deporte 3">
            <img src="http://localhost/comercio/proyecto/image/sport4.png" alt="Deporte 4">
            <img src="http://localhost/comercio/proyecto/image/sport5.png" alt="Deporte 5">
        </div>
    </div>
        <!--Productos-->
