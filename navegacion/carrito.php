...
<head>
    ...
    <title>Carrito | Zapped Shoes</title>
        ...
        <div class="row" style="margin-top: 10%">
                    ...
                    <div class="card-body mt-3">
                                <div class="row mb-4 align-items-center">
                                    <div class="col-md-2 col-4">
                                        <img src="http://localhost/comercio/proyecto/image/black.png"
                                             alt=""
                                             class="img-fluid rounded product-image">
                                    </div>
                                    <div class="col-md-4 col-8">
                                        <h6 class="text-muted mt-2">Nombre</h6>
                                        <h6 class="text-muted mt-2">Size</h6>
                                        <h6 class="text-muted mt-2">Color</h6>
                                       
                                    </div>
                                    <div class="col-md-2 col-4 mt-3 mt-md-0">
                                        <form action="../funciones/actualizar_carrito.php" method="POST">
                                    ...
                                    <div class="col-md-2 col-4 text-end mt-3 mt-md-0">
                                        <form action="../funciones/eliminar_carrito.php" method="POST">
                                            <input type="hidden" name="id" value="1">
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div id="paypal-button-container" class="mt-3 text-center"></div>
